...
com_torso = [-0.00413; 0.00009; 0.04342+HipOffsetZ];
...
%% DH parameters NOTE: Try changing to Modified DH
...
t_base_arm_R = [0,-ShoulderOffsetY-ElbowOffsetY,ShoulderOffsetZ+HipOffsetZ];
...
t_base_arm_L = [0,ShoulderOffsetY+ElbowOffsetY,ShoulderOffsetZ+HipOffsetZ];
...
t_offset_head = [0,-pi/2];
r_head = [0,0];
t_base_head = [0,0,NeckOffsetZ+HipOffsetZ];
