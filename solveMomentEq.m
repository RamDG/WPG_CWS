function [ T_C, x, y ] = solveMomentEq( zG, ddz_G,  dL, x_c, y_c,z_c,T_Cx,T_Cy,P_COG ) %add initial velocity?
...
T_C(1,:)  = interp1(TC.time',TC.signals.values(:,1),lt)';  
T_C(2,:)  = interp1(TC.time',TC.signals.values(:,2),lt)';  
end
